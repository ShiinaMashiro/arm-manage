<template>
  <div>
    <div class="search-btn">
      <el-button size="small" type="primary" @click="addPopShow = true"  v-if="$store.getters.checkChangeAuth()">添加介绍大类</el-button>
    </div>
    ...
    <!-- 添加faq -->
    <el-dialog title="添加介绍大类" :append-to-body="true" top="15vh"
    ...
    <!-- 修改faq -->
    <el-dialog title="修改介绍大类" :append-to-body="true" top="15vh"
               :close-on-click-modal="false" :show-close="false"
...
<script>
  export default {
    ...
    methods: {
      ...
      async deleteFAQ (id) {
        let that = this
        await that.$post(that.$uri.help.funClassDelete, {id})
      },
      /* 批量删除FAQ */
      deleteFAQBatch () {
